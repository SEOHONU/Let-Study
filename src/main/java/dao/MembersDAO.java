...
public class MembersDAO {
	...
	public boolean findPw(String id, String name, String email, String contact) throws Exception {
	...
	public MembersDTO myInfoSelect(String id) throws Exception {
		...
		try (Connection con = this.getConnection(); PreparedStatement pstat = con.prepareStatement(sql);) {
			...
			try (ResultSet rs = pstat.executeQuery();) {
				...
				MembersDTO dto = new MembersDTO(id, null, name, birth_date, nickname, contact, email, zipcode, address1,
						address2, join_date);
				return dto;
			}
		}
