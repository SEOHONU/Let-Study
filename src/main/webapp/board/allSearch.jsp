...
<body>
	...
	<div class="container">
		...
		<div class="row body">
			...
			<div class="col-12" style="height:300px;">후</div>
			<div class="col-12">
				<div class="row bodysub">
					...
					<div class="col-8">
						<div class="row">
							...
							<div class="col-12"
								style="text-align: center; background-color: #a0cbce;">공백</div>
													...
													<a href="/inner.studyboard?seq=${study.seq}&cpage=${cpage}">
														<div class="card">
															...
															<div class="card-body" style="text-align: center;">
																...
																<a
																	href="/inner.studyboard?seq=${study.seq}&cpage=${cpage}"
															...
															<div class="row g-0">
																...
																<div class="col-md-8">
																	<div class="card-body">
																		...
																		<p class="card-text">
																			<small class="text-body-secondary">${second.contents}</small>
																		</p>
																	</div>
																</div>
															</div>
									...
									<c:choose>
										<c:when test="${fdto.size()>0}">
											...
											<c:forEach var="free" items="${fdto}" begin="0" end="5">
												<div class="col-9">
													<a href="/detail.freeBoard?seq=${free.seq}">${free.title}</a>
												</div>
												<div class="col-3">
													<a href="/detail.freeBoard?seq=${free.seq}">${free.writer}</a>
												</div>
											</c:forEach>
								</div>
							</div>
